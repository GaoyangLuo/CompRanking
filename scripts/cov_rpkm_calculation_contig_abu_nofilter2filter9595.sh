...
if [ -e checkdone/${PREFIX}.cov.done ]; then
    ...
    # if [ "`ls -A ${INPUT_DIR}/${PREFIX}/CompRanking_intermediate/preprocessing/5M_contigs/cov/*5M*fa`" = "" ]; then 
    #     echo "No 5M fasta files"
    #     ln -s ${INPUT_DIR}/${PREFIX}/CompRanking_intermediate/preprocessing/5M_contigs/*5M*fa ${INPUT_DIR}/${PREFIX}/CompRanking_intermediate/preprocessing/5M_contigs/cov
    # else 
    #     echo "clean old 5M fasta files record..."
    #     rm ${INPUT_DIR}/${PREFIX}/CompRanking_intermediate/preprocessing/5M_contigs/cov/*5M*fa
    #     ln -s ${INPUT_DIR}/${PREFIX}/CompRanking_intermediate/preprocessing/5M_contigs/*5M*fa ${INPUT_DIR}/${PREFIX}/CompRanking_intermediate/preprocessing/5M_contigs/cov
    # fi
	...
	for i in ${INPUT_DIR}/${PREFIX}/CompRanking_intermediate/preprocessing/5M_contigs/cov_fa_nofiltered/*fa
    do
    ...
    bamm filter -b ${base}.sorted.bam -o ${INPUT_DIR}/${PREFIX}/CompRanking_intermediate/preprocessing/5M_contigs/cov_fa_nofiltered --percentage_id 0.95 --percentage_aln 0.95

    #run bbmap
    echo "[TIMESTAMP] $(date) Running bbmap..."
    pileup.sh in=${base}.sorted_filtered.bam out=${base}_5M_contigs_gene_contig_abundance9595.cov rpkm=${base}_5M_contigs_gene_contig_abundance9595.rpkm overwrite=true
